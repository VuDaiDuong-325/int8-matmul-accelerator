...
HD_PWD='D:/E/1subject/HK6/doan1/int8-matmul-accelerator/gemm_accelerator/gemm_accelerator.runs/gemm_system_axi_smc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gemm_system_axi_smc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gemm_system_axi_smc_2.tcl
