...
synth_design -top gemm_system_wrapper -part xck26-sfvc784-2LV-c
...
write_checkpoint -force -noxdef gemm_system_wrapper.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file gemm_system_wrapper_utilization_synth.rpt -pb gemm_system_wrapper_utilization_synth.pb"  } 
