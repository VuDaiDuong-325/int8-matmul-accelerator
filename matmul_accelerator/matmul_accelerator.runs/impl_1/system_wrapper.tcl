namespace eval ::optrace {
  variable script "D:/HK6/Project1/matmul_accelerator/matmul_accelerator.runs/impl_1/system_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir D:/HK6/Project1/matmul_accelerator/matmul_accelerator.cache/wt [current_project]
  set_property parent.project_path D:/HK6/Project1/matmul_accelerator/matmul_accelerator.xpr [current_project]
  set_property ip_repo_paths D:/HK6/Project1/matmul_accelerator/AXI4/npu_axi_ip_1_0 [current_project]
  update_ip_catalog
  set_property ip_output_repo D:/HK6/Project1/matmul_accelerator/matmul_accelerator.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet D:/HK6/Project1/matmul_accelerator/matmul_accelerator.runs/synth_1/system_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files D:/HK6/Project1/matmul_accelerator/matmul_accelerator.srcs/sources_1/bd/system/system.bd
