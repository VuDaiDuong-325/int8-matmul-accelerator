...
HD_PWD='D:/HK6/Project1/matmul_accelerator/matmul_accelerator.runs/system_npu_axi_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_npu_axi_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_npu_axi_ip_0_0.tcl
