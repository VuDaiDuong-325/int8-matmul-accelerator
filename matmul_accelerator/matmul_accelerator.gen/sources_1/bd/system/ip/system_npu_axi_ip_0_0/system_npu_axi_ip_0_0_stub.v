...
//               d:/HK6/Project1/matmul_accelerator/matmul_accelerator.gen/sources_1/bd/system/ip/system_npu_axi_ip_0_0/system_npu_axi_ip_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "system_npu_axi_ip_0_0,npu_axi_ip,{}" *) (* CORE_GENERATION_INFO = "system_npu_axi_ip_0_0,npu_axi_ip,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=user,x_ipName=npu_axi_ip,x_ipVersion=1.0,x_ipCoreRevision=5,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S00_AXI_DATA_WIDTH=32,C_S00_AXI_ADDR_WIDTH=6}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* X_CORE_INFO = "npu_axi_ip,Vivado 2025.2" *) 
module system_npu_axi_ip_0_0(s00_axi_awaddr, s00_axi_awprot, 
