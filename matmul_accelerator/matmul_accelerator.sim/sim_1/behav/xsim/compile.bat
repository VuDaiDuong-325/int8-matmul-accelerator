...
REM
REM Generated by Vivado on Sun Mar 22 16:24:04 +0700 2026
...
echo "xvlog --incr --relax -prj tb_matmul_array_vlog.prj"
call xvlog  --incr --relax -prj tb_matmul_array_vlog.prj -log xvlog.log
