...
int main() {
    ...
    *((volatile uint32_t *)(gpio_k_base + 0x00)) = (uint32_t)K_HW;
    ...
    fflush(stdout);
    dump_int8_to_file("input_A.txt", (int8_t *)master_A, M_TOTAL, K_TOTAL);
    dump_int8_to_file("input_B.txt", (int8_t *)master_B, K_TOTAL, N_TOTAL);
    dump_int32_to_file("output_C_FPGA.txt", (int32_t *)hw_C, M_TOTAL, N_TOTAL);
    printf("Done.\n");
