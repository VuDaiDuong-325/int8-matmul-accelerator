...
HD_PWD='D:/HK6/Project1/testing/accumulator/accumulator/accumulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log acc_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source acc_block_wrapper.tcl -notrace
