...
HD_PWD='D:/HK6/Project1/testing/accumulator/accumulator/accumulator.runs/acc_block_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acc_block_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acc_block_axi_gpio_0_0.tcl
