...
HD_PWD='D:/HK6/Project1/testing/accumulator/accumulator/accumulator.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log acc_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source acc_block_wrapper.tcl
