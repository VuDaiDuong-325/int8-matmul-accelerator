...
#                script (type 'acc_block.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/HK6/Project1/testing/accumulator/accumulator/accumulator.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
