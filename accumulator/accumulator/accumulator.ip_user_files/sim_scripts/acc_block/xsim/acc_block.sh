...
#
# Script generated by Vivado on Wed Mar 25 22:31:25 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : acc_block.sh
...
#
# Usage        : acc_block.sh
#                acc_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                acc_block.sh [-rerun]
#                acc_block.sh [-reset_run]
#                acc_block.sh [-clean]
#                acc_block.sh [-reset_log]
#                acc_block.sh [-help]
#
...
# script info
echo -e "acc_block.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./acc_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb acc_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./acc_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: acc_block.sh [-help]\n\
Usage: acc_block.sh [-step]\n\
Usage: acc_block.sh [-lib_map_path]\n\
Usage: acc_block.sh [-rerun]\n\
Usage: acc_block.sh [-reset_run]\n\
Usage: acc_block.sh [-clean]\n\
Usage: acc_block.sh [-reset_log]\n\
Usage: acc_block.sh [-keep_index]\n\
Usage: acc_block.sh [-noclean_files]\n\n\
