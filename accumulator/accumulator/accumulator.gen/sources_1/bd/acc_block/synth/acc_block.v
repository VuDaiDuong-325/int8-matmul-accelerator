...
//Date        : Wed Mar 25 22:37:38 2026
//Host        : VuDuong-32 running 64-bit major release  (build 9200)
//Command     : generate_target acc_block.bd
//Design      : acc_block
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "acc_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=acc_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_board_cnt=2,da_clkrst_cnt=2,da_zynq_ultra_ps_e_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "acc_block.hwdef" *) 
module acc_block
   ();

  wire [15:0]acc_reg_0_psum;
  ...
  acc_block_acc_reg_0_0 acc_reg_0
       (.a(xlslice_0_Dout),
        .b(xlslice_1_Dout),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .psum(acc_reg_0_psum),
        .rst_n(rst_ps8_0_99M_peripheral_aresetn),
        .start(xlslice_2_Dout));
  acc_block_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(acc_reg_0_psum),
  ...
  acc_block_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  acc_block_xlslice_0_0 xlslice_0
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_0_Dout));
  acc_block_xlslice_1_0 xlslice_1
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_1_Dout));
  acc_block_xlslice_2_0 xlslice_2
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_2_Dout));
  acc_block_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
