...
//Date        : Sat Apr 11 13:36:52 2026
//Host        : VuDuong-32 running 64-bit major release  (build 9200)
//Command     : generate_target gemm_block.bd
//Design      : gemm_block
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "gemm_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=gemm_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=9,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "gemm_block.hwdef" *) 
module gemm_block
   ();
  ...
  wire [511:0]gemm_accelerator_0_m_axis_c_TDATA;
  ...
  gemm_block_axi_dma_0_0 axi_dma_0
  ...
  gemm_block_axi_dma_1_0 axi_dma_1
       (.axi_resetn(rst_ps8_0_99M_peripheral_aresetn),
        .m_axi_mm2s_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  gemm_block_axi_gpio_0_0 axi_gpio_0
  ...
  gemm_block_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn));
  gemm_block_gemm_accelerator_0_0 gemm_accelerator_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn),
        ...
        .s_axis_a_tdata(axi_dma_1_M_AXIS_MM2S_TDATA),
        .s_axis_a_tlast(axi_dma_1_m_axis_mm2s_tlast),
        .s_axis_a_tready(axi_dma_1_M_AXIS_MM2S_TREADY),
        .s_axis_a_tvalid(axi_dma_1_M_AXIS_MM2S_TVALID),
  ...
  gemm_block_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  gemm_block_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
