...
int main() {
    ...
    size_t bytes_a = M_TILE * K_TOTAL * sizeof(int8_t); // 2048 Bytes
    size_t bytes_b = K_TOTAL * N_TILE * sizeof(int8_t); // 2048 Bytes
    ...
    *((volatile uint32_t *)(gpio_k_base + 0x00)) = K_TOTAL;
    ...
    printf("Done.\n");
    printf("Files generated: input_A.txt, input_B.txt, output_C_FPGA.txt\n\n");
