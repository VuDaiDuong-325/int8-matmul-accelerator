...
HD_PWD='D:/E/1subject/HK6/doan1/matmul/matmul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_top.tcl -notrace
