...
HD_PWD='D:/E/1subject/HK6/doan1/matmul/matmul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_top.tcl
