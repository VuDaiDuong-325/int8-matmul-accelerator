...
REM
REM Generated by Vivado on Tue Apr 07 16:11:36 +0700 2026
...
echo "xvlog --incr --relax -prj tb_array_top_auto_vlog.prj"
call xvlog  --incr --relax -prj tb_array_top_auto_vlog.prj -log xvlog.log
