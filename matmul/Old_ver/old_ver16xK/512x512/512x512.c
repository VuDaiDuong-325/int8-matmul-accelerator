...
int main() {
    ...
    // Sử dụng cấp phát động (malloc) để tránh Stack Overflow cho mảng lớn
    ...
    *((volatile uint32_t *)(gpio_k_base + 0x00)) = (uint32_t)K_HW;
    ...
    printf("[INFO] Running FPGA Accelerator (%dx%d) - Total 32,768 HW blocks...\n", M_TOTAL, N_TOTAL);
    ...
    printf("[INFO] Exporting TXT files...\n");
