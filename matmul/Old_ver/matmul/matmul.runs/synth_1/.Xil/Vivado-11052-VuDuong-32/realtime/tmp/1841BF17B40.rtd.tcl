...
set genomeRtd $env(RT_TMP)/1841BF17B40.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {gemm_accelerator__GC0}]"
puts "this genome's rtd file is $genomeRtd"
source $::env(HRT_TCL_PATH)/rtSynthPrep.tcl
source $::env(RT_TMP)/parameters.tcl
rt::set_parameter parallelChildUpdateCell true; rt::set_parameter parallelTimingMode true; rt::set_parameter parallelTimingModeRound 1; set rt::SDCFileList D:/HK6/Project1/testing/matmul_array/matmul/matmul.runs/synth_1/.Xil/Vivado-11052-VuDuong-32/realtime/tmp/parallel_timing.xdc; 
set genomeName [subst -nocommands -novariables {gemm_accelerator__GC0}]
