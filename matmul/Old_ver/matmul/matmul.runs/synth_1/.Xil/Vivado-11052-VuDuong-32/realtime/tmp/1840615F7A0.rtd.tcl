...
set genomeRtd $env(RT_TMP)/1840615F7A0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {matmul_array__GB0}]"
...
set genomeName [subst -nocommands -novariables {matmul_array__GB0}]
