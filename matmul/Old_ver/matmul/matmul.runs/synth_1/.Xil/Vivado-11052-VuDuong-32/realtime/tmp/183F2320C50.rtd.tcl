...
set genomeRtd $env(RT_TMP)/183F2320C50.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {matmul_array__GB6}]"
...
set genomeName [subst -nocommands -novariables {matmul_array__GB6}]
