...
#
# Script generated by Vivado on Mon Apr 13 10:35:28 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : fifo_512_to_128.sh
...
#
# Usage        : fifo_512_to_128.sh
#                fifo_512_to_128.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo_512_to_128.sh [-rerun]
#                fifo_512_to_128.sh [-reset_run]
#                fifo_512_to_128.sh [-clean]
#                fifo_512_to_128.sh [-reset_log]
#                fifo_512_to_128.sh [-help]
#
...
export RDI_DATADIR="E:/vivado/2025.2/Vivado/data"

# set xvlog options
xvlog_opts="--incr --relax  -L smartconnect_v1_0 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L xilinx_vip"
...
# script info
echo -e "fifo_512_to_128.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo_512_to_128.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L fifo_generator_v13_2_14 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot fifo_512_to_128 xil_defaultlib.fifo_512_to_128 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim fifo_512_to_128 -key {Behavioral:sim_1:Functional:fifo_512_to_128} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_31d6.protoinst" -protoinst "protoinst_files/bd_90f7.protoinst" -protoinst "protoinst_files/gemm_block.protoinst" -protoinst "protoinst_files/bd_5f09.protoinst" -protoinst "protoinst_files/bd_4c2e.protoinst" -protoinst "protoinst_files/gemm_block_v1.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="E:/vivado/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb fifo_512_to_128.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./fifo_512_to_128.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: fifo_512_to_128.sh [-help]\n\
Usage: fifo_512_to_128.sh [-step]\n\
Usage: fifo_512_to_128.sh [-lib_map_path]\n\
Usage: fifo_512_to_128.sh [-rerun]\n\
Usage: fifo_512_to_128.sh [-reset_run]\n\
Usage: fifo_512_to_128.sh [-clean]\n\
Usage: fifo_512_to_128.sh [-reset_log]\n\
Usage: fifo_512_to_128.sh [-keep_index]\n\
Usage: fifo_512_to_128.sh [-noclean_files]\n\n\
