...
#
# Script generated by Vivado on Wed Apr 08 19:58:08 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gemm_block.sh
...
#
# Usage        : gemm_block.sh
#                gemm_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gemm_block.sh [-rerun]
#                gemm_block.sh [-reset_run]
#                gemm_block.sh [-clean]
#                gemm_block.sh [-reset_log]
#                gemm_block.sh [-help]
#
...
# script info
echo -e "gemm_block.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gemm_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gemm_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gemm_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gemm_block.sh [-help]\n\
Usage: gemm_block.sh [-step]\n\
Usage: gemm_block.sh [-lib_map_path]\n\
Usage: gemm_block.sh [-rerun]\n\
Usage: gemm_block.sh [-reset_run]\n\
Usage: gemm_block.sh [-clean]\n\
Usage: gemm_block.sh [-reset_log]\n\
Usage: gemm_block.sh [-keep_index]\n\
Usage: gemm_block.sh [-noclean_files]\n\n\
