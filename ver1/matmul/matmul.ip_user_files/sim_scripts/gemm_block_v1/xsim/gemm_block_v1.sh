...
#
# Script generated by Vivado on Tue Apr 14 00:30:36 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : gemm_block_v1.sh
...
#
# Usage        : gemm_block_v1.sh
#                gemm_block_v1.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gemm_block_v1.sh [-rerun]
#                gemm_block_v1.sh [-reset_run]
#                gemm_block_v1.sh [-clean]
#                gemm_block_v1.sh [-reset_log]
#                gemm_block_v1.sh [-help]
#
...
# script info
echo -e "gemm_block_v1.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gemm_block_v1.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L zynq_ultra_ps_e_vip_v1_0_22 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_37 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_36 -L axi_lite_ipif_v3_0_4 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_37 -L xlconcat_v2_1_7 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot gemm_block_v1 xil_defaultlib.gemm_block_v1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim gemm_block_v1 -key {Behavioral:sim_1:Functional:gemm_block_v1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_31d6.protoinst" -protoinst "protoinst_files/bd_90f7.protoinst" -protoinst "protoinst_files/gemm_block.protoinst" -protoinst "protoinst_files/bd_5f09.protoinst" -protoinst "protoinst_files/bd_4c2e.protoinst" -protoinst "protoinst_files/gemm_block_v1.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb gemm_block_v1.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./gemm_block_v1.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: gemm_block_v1.sh [-help]\n\
Usage: gemm_block_v1.sh [-step]\n\
Usage: gemm_block_v1.sh [-lib_map_path]\n\
Usage: gemm_block_v1.sh [-rerun]\n\
Usage: gemm_block_v1.sh [-reset_run]\n\
Usage: gemm_block_v1.sh [-clean]\n\
Usage: gemm_block_v1.sh [-reset_log]\n\
Usage: gemm_block_v1.sh [-keep_index]\n\
Usage: gemm_block_v1.sh [-noclean_files]\n\n\
