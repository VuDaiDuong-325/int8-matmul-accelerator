...
HD_PWD='D:/E/1subject/HK6/doan1/ver1/matmul/matmul.runs/gemm_block_v1_zynq_ultra_ps_e_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gemm_block_v1_zynq_ultra_ps_e_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gemm_block_v1_zynq_ultra_ps_e_0_0.tcl
