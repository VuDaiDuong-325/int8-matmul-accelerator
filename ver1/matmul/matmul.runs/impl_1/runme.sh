...
HD_PWD='D:/E/1subject/HK6/doan1/ver1/matmul/matmul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log gemm_block_v1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source gemm_block_v1_wrapper.tcl -notrace
