...
HD_PWD='D:/E/1subject/HK6/doan1/ver1/matmul/matmul.runs/fifo_512_to_128_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fifo_512_to_128.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fifo_512_to_128.tcl
