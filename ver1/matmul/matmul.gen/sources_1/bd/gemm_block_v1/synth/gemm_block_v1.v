...
(* CORE_GENERATION_INFO = "gemm_block_v1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=gemm_block_v1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "gemm_block_v1.hwdef" *) 
module gemm_block_v1
   ();
  ...
  gemm_block_v1_axi_dma_0_0 axi_dma_0
  ...
  gemm_block_v1_axi_dma_1_0 axi_dma_1
       (.axi_resetn(rst_ps8_0_99M_peripheral_aresetn),
        .m_axi_mm2s_aclk(zynq_ultra_ps_e_0_pl_clk0),
  ...
  gemm_block_v1_axi_gpio_0_0 axi_gpio_0
  ...
  gemm_block_v1_axi_smc_0 axi_smc
  ...
  gemm_block_v1_axi_smc_1_0 axi_smc_1
       (.M00_AXI_araddr(axi_smc_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn));
  gemm_block_v1_gemm_accelerator_0_0 gemm_accelerator_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn),
        .k_dim(axi_gpio_0_gpio_io_o),
        .m_axis_c_tdata(gemm_accelerator_0_m_axis_c_TDATA),
        .m_axis_c_tlast(gemm_accelerator_0_m_axis_c_TLAST),
        .m_axis_c_tready(gemm_accelerator_0_m_axis_c_TREADY),
        .m_axis_c_tvalid(gemm_accelerator_0_m_axis_c_TVALID),
        ...
        .s_axis_b_tdata(axi_dma_1_M_AXIS_MM2S_TDATA),
        .s_axis_b_tlast(axi_dma_1_M_AXIS_MM2S_TLAST),
        .s_axis_b_tready(axi_dma_1_M_AXIS_MM2S_TREADY),
        .s_axis_b_tvalid(axi_dma_1_M_AXIS_MM2S_TVALID));
  gemm_block_v1_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  gemm_block_v1_xlconcat_0_0 xlconcat_0
       (.In0(axi_dma_0_mm2s_introut),
        .In1(axi_dma_0_s2mm_introut),
        .In2(axi_dma_1_mm2s_introut),
        .dout(xlconcat_0_dout));
  gemm_block_v1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
