...
// ==========================================
// [SỬA LẠI] Kích thước thật của ma trận: 1280x1280
// ==========================================
#define M_TOTAL 1280
#define K_TOTAL 1280
#define N_TOTAL 1280
...
// Giới hạn chunk K để lách luật phần cứng
...
int main() {
                ...
                *((volatile uint32_t *)(gpio_k_base + 0x00)) = 0;
                ...
                for (int i = 0; i < M_TILE; i++) {
                    for (int j = 0; j < N_TILE; j++) {
                        partial_C_tile[M_TILE - 1 - i][j] += rx_c_ram[idx_c++]; 
                    }
                }
            } 
    ...
    fflush(stdout);
    dump_int8_to_file("input_A_1280.txt", master_A, M_TOTAL, K_TOTAL);
    dump_int8_to_file("input_B_1280.txt", master_B, K_TOTAL, N_TOTAL);
    dump_int32_to_file("output_C_1280_FPGA.txt", hw_C, M_TOTAL, N_TOTAL);
    printf("Done.\n");
