...
HD_PWD='D:/HK6/Project1/testing/matmul_array/matmul/matmul.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log array_block_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source array_block_wrapper.tcl
