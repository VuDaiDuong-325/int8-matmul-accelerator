...
HD_PWD='D:/HK6/Project1/testing/matmul_array/matmul/matmul.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log array_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source array_block_wrapper.tcl -notrace
