...
(* CORE_GENERATION_INFO = "array_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=array_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_board_cnt=1,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=2,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "array_block.hwdef" *) 
module array_block
   ();
  ...
  array_block_array_top_0_0 array_top_0
       (.clk(axi_gpio_0_gpio_io_o[0]),
        .rd_addr({1'b0,1'b0,1'b0,1'b0}),
        .rst_n(axi_gpio_0_gpio_io_o[0]),
        .start_btn(axi_gpio_0_gpio_io_o[0]));
