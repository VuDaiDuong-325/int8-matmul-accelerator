...
#
# Script generated by Vivado on Tue Mar 31 21:15:01 +0700 2026
# SW Build 6299465 on Fri Nov 14 19:35:11 GMT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : mul_block.sh
...
#
# Usage        : mul_block.sh
#                mul_block.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mul_block.sh [-rerun]
#                mul_block.sh [-reset_run]
#                mul_block.sh [-clean]
#                mul_block.sh [-reset_log]
#                mul_block.sh [-help]
#
...
export RDI_DATADIR="D:/Apps/Study/Vivado/2025.2/Vivado/data"
...
# script info
echo -e "mul_block.sh - Script generated by export_simulation (Vivado v2025.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mul_block.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="D:/Apps/Study/Vivado/2025.2/Vivado/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mul_block.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mul_block.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mul_block.sh [-help]\n\
Usage: mul_block.sh [-step]\n\
Usage: mul_block.sh [-lib_map_path]\n\
Usage: mul_block.sh [-rerun]\n\
Usage: mul_block.sh [-reset_run]\n\
Usage: mul_block.sh [-clean]\n\
Usage: mul_block.sh [-reset_log]\n\
Usage: mul_block.sh [-keep_index]\n\
Usage: mul_block.sh [-noclean_files]\n\n\
