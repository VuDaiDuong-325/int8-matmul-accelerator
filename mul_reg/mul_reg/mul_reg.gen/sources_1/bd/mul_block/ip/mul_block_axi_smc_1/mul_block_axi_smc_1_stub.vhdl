...
-- Command     : write_vhdl -force -mode synth_stub -rename_top mul_block_axi_smc_1 -prefix
--               mul_block_axi_smc_1_ mul_block_axi_smc_1_stub.vhdl
...
entity mul_block_axi_smc_1 is
  ...
  attribute CHECK_LICENSE_TYPE of mul_block_axi_smc_1 : entity is "mul_block_axi_smc_1,bd_b81e,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of mul_block_axi_smc_1 : entity is "mul_block_axi_smc_1,bd_b81e,{x_ipProduct=Vivado 2025.2,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=28,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of mul_block_axi_smc_1 : entity is "yes";
end mul_block_axi_smc_1;

architecture stub of mul_block_axi_smc_1 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN mul_block_zynq_ultra_ps_e_0_0_pl_clk0, ASSOCIATED_BUSIF M00_AXI:S00_AXI:S01_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_b81e,Vivado 2025.2";
begin
end;
