...
//Date        : Tue Mar 31 21:19:20 2026
//Host        : VuDuong-32 running 64-bit major release  (build 9200)
//Command     : generate_target mul_block.bd
//Design      : mul_block
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "mul_block,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=mul_block,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_board_cnt=2,da_clkrst_cnt=1,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "mul_block.hwdef" *) 
module mul_block
   ();
  ...
  mul_block_axi_gpio_0_0 axi_gpio_0
       (.gpio2_io_i(mul_pu_0_res),
  ...
  mul_block_rst_ps8_0_99M_0 rst_ps8_0_99M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  mul_block_xlslice_0_0 xlslice_0
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_0_Dout));
  mul_block_xlslice_1_0 xlslice_1
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_1_Dout));
  mul_block_xlslice_2_0 xlslice_2
       (.Din(axi_gpio_0_gpio_io_o),
        .Dout(xlslice_2_Dout));
  mul_block_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
