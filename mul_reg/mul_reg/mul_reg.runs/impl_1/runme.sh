...
HD_PWD='D:/HK6/Project1/testing/mul_reg/mul_reg/mul_reg.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_block_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mul_block_wrapper.tcl -notrace
