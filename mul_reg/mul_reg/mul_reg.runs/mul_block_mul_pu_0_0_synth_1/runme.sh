...
HD_PWD='D:/HK6/Project1/testing/mul_reg/mul_reg/mul_reg.runs/mul_block_mul_pu_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mul_block_mul_pu_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mul_block_mul_pu_0_0.tcl
